...
double targetSpeed = 8.0; //miles per hour
double speedTolerance = 0.3; // +/- miles per hour
...
int drive = 11; //pin 11
int pointid = 0;
char waypointBehavior = 'l'; // r means reverse at end of goalpoints, l means loop
...
void gpsdump(TinyGPS &gps)
{
  ...
  //Junior High Field Loop
  float goal[] = {39.24652, -94.43122, 3.0, 39.24680, -94.43100, 3.0, 39.24652, -94.43149, 3.0};
  //Junior High Track
  //float goal[] = {39.24686, -94.43091, 3.0, 39.24702, -94.43100, 3.0, 39.24712, -94.43122, 3.0, 39.24705, -94.43149, 3.0, 39.24686, -94.43159, 3.0, 39.24668, -94.43159, 3.0, 39.24637, -94.43159, 3.0, 39.24621, -94.43156, 3.0, 39.24612, -94.43126, 3.0, 39.24621, -94.43106, 3.0, 39.24633, -94.43090, 3.0, 39.24662, -94.43090, 3.0};

//float goal[] = {39.24695, -94.41040, 3.0, 39.24676, -94.41022, 3.0, 39.24670, -94.40990, 3.0, 39.24678, -94.40962, 3.0, 39.24695, -94.40943, 3.0, 39.24740, -94.40943, 3.0, 39.24785, -94.40943, 3.0, 39.24809, -94.40968, 3.0, 39.24820, -94.40990, 3.0, 39.24809, -94.41022, 3.0, 39.24785, -94.41040, 3.0, 39.24740, -94.41040, 3.0};
...
//float goal[] = {39.24695, -94.41038, 5.0, 39.24678, -94.41020, 5.0, 39.24671, -94.40990, 5.0, 39.24678, -94.40962, 5.0, 39.24695, -94.40944, 5.0, 39.24785, -94.40940, 5.0, 39.24809, -94.40955, 5.0, 39.24818, -94.40990, 5.0, 39.24809, -94.41022, 5.0, 39.24785, -94.41038, 5.0}; // lat1, lon1, accuracy1, lat2, lon2, accuracy2, etc.
  ...
  steeringAngle = map(directionDifference, -180, 180, 116, 64);
...
void adjustSpeed(){
  if(adjustMySpeed){
    if(speedmph > targetSpeed + speedTolerance && speedValue < 95){
      speedValue++;
    }
    if(speedmph < targetSpeed - speedTolerance && speedValue > 90){
      speedValue--;
    }
  }
}
